  ...
  return (
    <>
      ...
      <button onClick={() => setModalOpen(true)}
        className="fixed right-5 bottom-[calc(112px+env(safe-area-inset-bottom,0px))] z-50 flex h-13 w-13 items-center justify-center rounded-2xl bg-primary shadow-lg shadow-primary/25 text-primary-foreground transition-transform active:scale-90 pulse-glow will-change-transform">
