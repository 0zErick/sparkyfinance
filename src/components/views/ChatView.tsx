...
const ChatView = () => {
  ...
  return (
    <div className="flex flex-col overflow-hidden h-full min-h-screen pt-[env(safe-area-inset-top,20px)] touch-pan-y">
      ...
      {/* Messages */}
      <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-4 space-y-3 pb-4">
        {messages.length === 0 && (
      ...
      <div className="flex-shrink-0 px-4 pt-2 border-t border-border bg-background pb-[calc(0.75rem+env(safe-area-inset-bottom,0px))]">
