...
<div className="space-y-3">
  ...
  <div className="grid grid-cols-2 gap-2">
    <div className="card-zelo border-l-4 border-l-success min-h-[68px]">
    ...
    <div className="card-zelo border-l-4 border-l-destructive min-h-[68px]">
      <div className="flex items-center gap-2 mb-1">
  ...
  {flatList.length === 0 ? (
    ...
    <div ref={parentRef} className="overflow-y-auto max-h-[calc(100vh-340px)]">
