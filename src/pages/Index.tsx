...
const Index = () => {
  ...
  if (maintenanceActive && !isAdmin) {
    return (
      <div className="bg-background flex flex-col items-center justify-center text-center px-8 h-screen">
  ...
  return (
    <div
      className="bg-background relative mx-auto flex w-full max-w-lg flex-col lg:max-w-4xl xl:max-w-6xl h-screen max-h-screen min-h-screen overflow-hidden overscroll-contain"
    >
      ...
      <div data-main-scroll className={`relative flex-1 min-h-0 overflow-x-hidden ${activeTab === 'chat' ? 'overflow-hidden' : 'overflow-y-auto'} overscroll-contain`} style={{ paddingBottom: activeTab === 'chat' ? '0' : 'calc(100px + env(safe-area-inset-bottom, 0px))' }}>
        <Suspense fallback={
          <div className="space-y-3 px-4 pt-4">
            <div className="h-10 w-40 bg-muted rounded-xl animate-pulse" />
            <div className="bg-muted rounded-2xl animate-pulse h-[120px]" />
            <div className="bg-muted rounded-2xl animate-pulse h-[100px]" />
            <div className="bg-muted rounded-2xl animate-pulse h-[100px]" />
          </div>
        }>
